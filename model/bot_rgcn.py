...
class BotRGCN(BaseGCNModel):
    ...
    def __init__(
        ...
        self.rgcn1 = RGCNConv(in_channels, hidden_channels, num_relations=num_relations)

        self.rgcn2 = RGCNConv(in_channels, hidden_channels, num_relations=num_relations)
